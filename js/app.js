...
document.getElementById("password-utente").innerHTML = `La tua password è: <strong class="text-lowercase">${nomeUtente}${cognomeUtente}${coloreUtente}${numeroFisso}</strong> !`;